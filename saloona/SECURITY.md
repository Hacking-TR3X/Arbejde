...
Seneste gennemgang: 2026-09-26. Første runde dækkede fase 1–4 og CI. Anden runde verificerede rettelserne i `dcf14d7` og `5a0ed60`.
...
- **Build:**
  ...
  - Testversionen er build-typen `pilot`. Den er `initWith release` (ikke debuggable, R8), har app-id `dk.saloona.app.test` og signeres med CI's testnøgle.
